# PFO1 - Portafolio Personal

**Descripción:** Este trabajo práctico corresponde a la Práctica Formativa Obligatoria 1. Es una landing page de portafolio personal que muestra un perfil ficticio, proyectos, habilidades, formulario de contacto y películas favoritas.
...
Respuesta: Elegí Roboto porque es una fuente moderna, legible y funciona bien para texto en pantallas.
• HTML:
...
Respuesta: Flexbox facilita el orden de las tarjetas y permite crear un diseño adaptable sin mucho código.
...
Respuesta: Se aplicaron transiciones suaves en tarjetas y botones para mejorar la interacción visual sin distraer.
